            ...
            <div class="col-md-8">
                ...
                <div v-else class="form_block">
                    <div class="mb-4">
                        ...
                        <div><input type="text" placeholder="Enter region name" class="form-control" v-model="formData.title" ref="city_title" /></div>
                    </div>                    
                    <div>
                        <label>Status</label>
            ...
            <div class="col-md-4">
                ...
                <div v-else class="info_block">
                    <div class="item_block mb-4">
                        ...
                        <select v-model="formData.region_id" class="form-control parent-dropdown" ref="region_list">
...
export default {
    ...
    methods: {
        ...
        async load_req_data(id){
            ...
            this.$axios.get('/api/cities/edit/' + id, this.$parent.header_config).then( (response) => {
        ...
        async formSubmit(){
            ...
            if(this.formData.title.trim()==''){
                this.$toast.error('Please enter city name', {icon: "Warning"});
                this.$refs.city_title.focus();
                return false;
            ...
            if(confirm('Are you sure to submit it?')){
                ...
                await this.$parent.citySubmit(submit_data);
