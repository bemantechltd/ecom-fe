...
export default {
    ...
    methods: {
        ...
        async load_req_data(id){
            ...
            this.$axios.get('/api/pharma-companies/edit/' + id, this.$parent.header_config).then( (response) => {
        ...
        async formSubmit(){
            ...
            if(confirm('Are you sure to submit it?')){
                ...
                await this.$parent.pharmaCompanySubmit(submit_data);
                ...
                if(this.form_action == 'save'){
                    ...
                    this.formData.exist_logo = this.$store.state.pharma_company_info.get_data['logo']
                }
            }            
        },
        form_reset(){
