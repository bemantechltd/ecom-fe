            ...
            <div class="col-md-8">
                ...
                <div v-else class="form_block">
                    <div class="mb-4">
                        ...
                        <div><input type="text" placeholder="Enter tag name" class="form-control" v-model="formData.tag_title" ref="tag_title" /></div>
                    </div>                    
                    <div>
                        <label>Status</label>
...
export default {
    ...
    methods: {
        ...
        async load_req_data(id){
            ...
            this.$axios.get('/api/tags/edit/' + id, this.$parent.header_config).then( (response) => {
                console.log('Get Data', response.data)
                let getData = response.data;

                this.formData = {
                    tag_title: getData.tag_title,
        ...
        async formSubmit(){
            ...
            if(this.formData.tag_title.trim()==''){
                this.$toast.error('Please enter tag name', {icon: "Warning"});
                this.$refs.tag_title.focus();
                return false;
            }
            ...
            if(confirm('Are you sure to submit it?')){
                ...
                await this.$parent.tagSubmit(submit_data);
