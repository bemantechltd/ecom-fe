                ...
                <template v-else>                    
                    <div class="info_block">
                        ...
                        <div class="content-wrapper-block">
                            <CartItemListView />
                            <OrderSummaryInfo v-if="$store.state.cart_info.total_cart_items>0" />
                        </div>
                    </div>
...
import OrderSummaryInfo from '@/pages/checkout-page/components/OrderSummaryInfo'
...
<style lang="scss" scoped>
    ...
    .content-wrapper-block ::v-deep .order_summary_info_block{
        padding: 15px 0
    }
</style>