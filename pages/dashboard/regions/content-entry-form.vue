            ...
            <div class="col-md-8">
                ...
                <div v-else class="form_block">
                    <div class="mb-4">
                        ...
                        <div><input type="text" placeholder="Enter region name" class="form-control" v-model="formData.title" ref="region_title" /></div>
                    </div>                    
                    <div>
                        <label>Status</label>
...
export default {
    ...
    methods: {
        ...
        async load_req_data(id){
            ...
            this.$axios.get('/api/regions/edit/' + id, this.$parent.header_config).then( (response) => {
        ...
        async formSubmit(){
            ...
            if(this.formData.title.trim()==''){
                this.$toast.error('Please enter region name', {icon: "Warning"});
                this.$refs.region_title.focus();
                return false;
            }
            ...
            if(confirm('Are you sure to submit it?')){
                ...
                await this.$parent.regionSubmit(submit_data);
