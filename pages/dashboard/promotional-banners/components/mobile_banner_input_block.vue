...
<style scoped>    
    ...
    .mobile_banner_image_block > div{
        width: 100%; height: 100%; text-align: center;
    }    
    .mobile_banner_image_block span.browse_btn{
        position: absolute;
        bottom: 40%;
        left: 0;
        right: 0;
    ...
    .mobile_banner_image_block:hover span.browse_btn{
        background-color: purple;
        opacity: 1.0;
    }
    .mobile_banner_image_block >>> img{
        width: 270px;
        height: 120px;
        object-fit: contain;
        /* padding: 5px; */
    ...
    .mobile_banner_image_block >>> .action_btn{
        position: absolute;
        right: 0;
        bottom: 0px;
        width: 24px;
    ...
    .mobile_banner_image_block >>> .cancel_btn{
        right: -10px;
        top: -10px;        
    }
    input[type="file"]{
